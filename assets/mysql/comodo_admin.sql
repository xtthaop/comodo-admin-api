...
CREATE TABLE `sys_dict_data` (
  ...
  `dict_data_sort` bigint NOT NULL COMMENT '排序',
  ...
  `dict_id` bigint NOT NULL COMMENT '所属字典类型 id',
...
INSERT INTO `sys_dict_type` VALUES (1,'系统开关','sys_normal_disable',1,'',1,1,'2021-08-05 11:39:05','2023-12-29 22:06:36'),(2,'用户性别','sys_user_sex',1,NULL,1,NULL,'2021-08-05 11:45:23',NULL),(3,'菜单状态','sys_show_hide',1,NULL,1,12,'2021-08-05 11:46:19','2024-01-28 10:11:10');
...
INSERT INTO `sys_login_log` VALUES (345,'admin','172.16.226.1',NULL,'Chrome(120.0.0.0)','MAC','2024-01-31 22:58:41');
...
CREATE TABLE `sys_menu` (
  ...
  `visible` tinyint NOT NULL DEFAULT '1' COMMENT '是否显示，0：隐藏；1：显示；2：未知',
  `is_link` tinyint DEFAULT '0' COMMENT '是否外链，0：否；1：是',
  `layout` tinyint DEFAULT '1' COMMENT '是否显示布局，0：否；1：是',
...
INSERT INTO `sys_menu` VALUES (1,'SysMenu','菜单管理',NULL,'/admin/sys-menu','P','admin:sysmenu',2,'/admin/sys-menu/index.vue',2,1,0,1,0,NULL,1,'2021-08-05 11:05:32','2024-01-07 22:48:39',NULL),(2,NULL,'系统管理','setting',NULL,'F',NULL,0,NULL,199,1,NULL,NULL,NULL,1,1,'2021-08-05 11:36:08','2024-01-07 22:47:02',NULL),(3,'SysDict','字典管理',NULL,'/admin/sys-dict','P','admin:sysdict',2,'/admin/sys-dict/index.vue',4,1,0,1,0,1,1,'2021-08-05 11:37:34','2024-01-13 20:13:26',NULL),(4,'SysDictData','字典数据管理',NULL,'/admin/sys-dict/data/:dictId','P','admin:sysdictdata',3,'/admin/sys-dict/data.vue',0,0,0,1,0,1,1,'2021-08-05 11:40:54','2024-01-12 23:05:01','/admin/sys-dict'),(5,'SysUser','用户管理',NULL,'/admin/sys-user','P','admin:sysuser',2,'/admin/sys-user/index.vue',0,1,0,1,0,1,1,'2021-08-05 11:48:47','2024-01-12 00:32:59',NULL),(6,'SysRole','角色管理',NULL,'/admin/sys-role','P','admin:sysrole',2,'/admin/sys-role/index.vue',1,1,0,1,0,1,1,'2021-08-05 11:49:40','2024-01-07 22:48:16',NULL),(7,'SysApi','接口管理',NULL,'/admin/sys-api','P','admin:sysapi',2,'/admin/sys-api/index.vue',3,1,0,1,0,1,1,'2021-08-05 11:51:29','2024-01-07 22:50:11',NULL),(8,NULL,'系统日志',NULL,NULL,'F',NULL,2,NULL,5,1,NULL,NULL,NULL,1,1,'2021-08-05 11:52:24','2024-01-07 22:52:14',NULL),(9,'SysLoginLog','登录日志',NULL,'/admin/sys-login-log','P','admin:sysloginlog',8,'/admin/sys-login-log/index.vue',0,1,0,1,0,1,1,'2021-08-05 11:53:18','2024-01-07 22:52:36',NULL),(10,'SysOperationLog','操作日志',NULL,'/admin/sys-operation-log','P','admin:sysoperationlog',8,'/admin/sys-operation-log/index.vue',1,1,0,1,0,1,1,'2021-08-05 11:54:06','2024-01-07 22:52:39',NULL),(11,NULL,'新增用户',NULL,NULL,'B','admin:sysuser:add',5,NULL,1,2,NULL,NULL,NULL,1,1,'2021-08-09 13:40:48','2024-01-07 22:53:19',NULL),(12,NULL,'修改用户',NULL,NULL,'B','admin:sysuser:edit',5,NULL,2,2,NULL,NULL,NULL,1,1,'2021-08-09 13:41:28','2024-01-07 22:53:22',NULL),(13,NULL,'删除用户',NULL,NULL,'B','admin:sysuser:remove',5,NULL,3,2,NULL,NULL,NULL,1,1,'2021-08-09 13:42:02','2024-01-07 22:53:24',NULL),(14,NULL,'重置密码',NULL,NULL,'B','admin:sysuser:resetpassword',5,NULL,4,2,NULL,NULL,NULL,1,1,'2021-08-09 13:42:40','2024-01-07 22:53:27',NULL),(15,NULL,'修改状态',NULL,NULL,'B','admin:sysuser:status',5,NULL,5,2,NULL,NULL,NULL,1,12,'2021-08-09 13:43:46','2024-01-28 23:32:56',NULL),(16,NULL,'新增角色',NULL,NULL,'B','admin:sysrole:add',6,NULL,0,2,NULL,NULL,NULL,1,1,'2021-08-09 14:01:28','2024-01-07 22:53:31',NULL),(17,NULL,'修改角色',NULL,NULL,'B','admin:sysrole:update',6,NULL,0,2,NULL,NULL,NULL,1,1,'2021-08-09 14:02:28','2024-01-07 22:53:33',NULL),(18,NULL,'删除角色',NULL,NULL,'B','admin:sysrole:remove',6,NULL,0,2,NULL,NULL,NULL,1,1,'2021-08-09 14:03:09','2024-01-07 22:53:35',NULL),(19,NULL,'修改状态',NULL,NULL,'B','admin:sysrole:status',6,NULL,0,2,NULL,NULL,NULL,1,12,'2021-08-09 14:03:58','2024-01-29 23:10:23',NULL),(20,NULL,'新增菜单',NULL,NULL,'B','admin:sysmenu:add',1,NULL,0,2,NULL,NULL,NULL,1,1,'2021-08-09 14:09:36','2024-01-07 22:53:41',NULL),(21,NULL,'修改菜单',NULL,NULL,'B','admin:sysmenu:edit',1,NULL,0,2,NULL,NULL,NULL,1,1,'2021-08-09 14:10:18','2024-01-07 22:53:44',NULL),(22,NULL,'删除菜单',NULL,NULL,'B','admin:sysmenu:remove',1,NULL,0,2,NULL,NULL,NULL,1,1,'2021-08-09 14:10:42','2024-01-07 22:53:46',NULL),(23,NULL,'新增接口',NULL,NULL,'B','admin:sysapi:add',7,NULL,0,2,NULL,NULL,NULL,1,1,'2021-08-09 14:13:30','2024-01-07 22:53:49',NULL),(24,NULL,'修改接口',NULL,NULL,'B','admin:sysapi:edit',7,NULL,0,2,NULL,NULL,NULL,1,1,'2021-08-09 14:13:56','2024-01-07 22:53:51',NULL),(25,NULL,'删除接口',NULL,NULL,'B','admin:sysapi:remove',7,NULL,0,2,NULL,NULL,NULL,1,1,'2021-08-09 14:14:27','2024-01-07 22:53:52',NULL),(26,NULL,'添加字典类型',NULL,NULL,'B','admin:sysdicttype:add',3,NULL,0,2,NULL,NULL,NULL,1,1,'2021-08-09 14:17:05','2024-01-07 22:53:56',NULL),(27,NULL,'修改字典类型',NULL,NULL,'B','admin:sysdicttype:edit',3,NULL,0,2,NULL,NULL,NULL,1,1,'2021-08-09 14:17:32','2024-01-07 22:53:58',NULL),(28,NULL,'删除字典类型',NULL,NULL,'B','admin:sysdicttype:remove',3,NULL,0,2,NULL,NULL,NULL,1,1,'2021-08-09 14:18:30','2024-01-07 22:54:00',NULL),(29,NULL,'添加字典数据',NULL,NULL,'B','admin:sysdictdata:add',4,NULL,0,2,NULL,NULL,NULL,1,1,'2021-08-09 14:19:51','2024-01-07 22:54:01',NULL),(30,NULL,'修改字典数据',NULL,NULL,'B','admin:sysdictdata:edit',4,NULL,0,2,NULL,NULL,NULL,1,1,'2021-08-09 14:20:15','2024-01-07 22:54:03',NULL),(31,NULL,'删除字典数据',NULL,NULL,'B','admin:sysdictdata:remove',4,NULL,0,2,NULL,NULL,NULL,1,1,'2021-08-09 14:20:37','2024-01-07 22:54:06',NULL),(32,NULL,'删除登录日志',NULL,NULL,'B','admin:sysloginlog:remove',9,NULL,0,2,NULL,NULL,NULL,1,1,'2021-08-09 14:22:13','2024-01-07 22:54:07',NULL),(33,NULL,'删除操作日志',NULL,NULL,'B','admin:sysoperationlog:remove',10,NULL,0,2,NULL,NULL,NULL,1,1,'2021-08-09 14:22:38','2024-01-07 22:54:10',NULL);
...
INSERT INTO `sys_menu_api_rule` VALUES (1,1),(1,2),(6,2),(20,3),(21,4),(22,5),(1,6),(7,6),(23,7),(24,8),(25,9),(5,10),(6,10),(16,11),(17,12),(19,12),(18,14),(5,15),(11,16),(13,17),(12,18),(15,18),(14,20),(3,21),(26,22),(27,23),(28,24),(4,25),(29,26),(30,27),(31,28),(9,29),(32,30),(10,31),(33,32);
...
CREATE TABLE `sys_operation_log` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=7365 DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `sys_operation_log` VALUES (7353,'GET','admin','/sys_user','172.16.226.1','6.07ms','2024-01-31 22:56:35','获取用户列表'),(7354,'GET','admin','/sys_role','172.16.226.1','2.9ms','2024-01-31 22:56:35','查询角色列表'),(7355,'PUT','admin','/sys_user/update_user','172.16.226.1','14.59ms','2024-01-31 22:57:08','修改用户信息'),(7356,'GET','admin','/sys_user','172.16.226.1','4.7ms','2024-01-31 22:57:08','获取用户列表'),(7357,'GET','admin','/sys_user','172.16.226.1','3.9ms','2024-01-31 22:58:41','获取用户列表'),(7358,'GET','admin','/sys_role','172.16.226.1','1.68ms','2024-01-31 22:58:41','查询角色列表'),(7359,'GET','admin','/sys_log/get_login_log','172.16.226.1','4.76ms','2024-01-31 22:58:44','查询登录日志列表'),(7360,'GET','admin','/sys_log/get_operation_log','172.16.226.1','3.19ms','2024-01-31 22:58:46','查询操作日志列表'),(7361,'GET','admin','/sys_log/get_login_log','172.16.226.1','3.56ms','2024-01-31 22:58:47','查询登录日志列表'),(7362,'GET','admin','/sys_log/get_operation_log','172.16.226.1','2.85ms','2024-01-31 22:58:51','查询操作日志列表'),(7363,'GET','admin','/sys_role','172.16.226.1','2.67ms','2024-01-31 22:58:53','查询角色列表'),(7364,'GET','admin','/sys_user','172.16.226.1','2.48ms','2024-01-31 22:58:53','获取用户列表');
...
CREATE TABLE `sys_role` (
  ...
  `role_key` varchar(128) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '角色标识',
  `role_sort` bigint NOT NULL COMMENT '排序',
  `remark` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL COMMENT '备注',
  `create_by` bigint DEFAULT NULL COMMENT '创建者',
  `update_by` bigint DEFAULT NULL COMMENT '更新者',
  `created_at` datetime DEFAULT NULL COMMENT '创建时间',
...
INSERT INTO `sys_role` VALUES (1,'超级管理员',1,'admin',0,NULL,NULL,12,'2021-08-05 11:00:25','2024-01-23 22:07:34'),(7,'测试角色',1,'test',1,NULL,12,12,'2024-01-23 22:08:03','2024-01-29 23:28:37');
...
INSERT INTO `sys_role_menu_rule` VALUES (7,2),(7,5),(7,6),(7,8),(7,10),(7,11),(7,13),(7,14),(7,16),(7,17),(7,18),(7,19),(7,33);
...
INSERT INTO `sys_user` VALUES (12,'admin','60bd267688f7479cd8624894165acb61','18789909099','male','961116034@qq.com',NULL,1,NULL,12,'2024-01-21 22:36:02','2024-01-31 22:57:08','超级管理员'),(13,'user1','60bd267688f7479cd8624894165acb61','19099999999',NULL,NULL,NULL,1,12,12,'2024-01-23 21:53:31','2024-01-24 23:43:07','用户1');
...
-- Dump completed on 2024-01-31 22:59:01
