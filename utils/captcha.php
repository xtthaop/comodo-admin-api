...
Class Captcha {
  ...
  public function makeCaptcha(){
    ...
    $srcFile = './assets/image/captcha/bp' . mt_rand(1, 3) . '.jpeg';
    $src_w = 320;
    $src_h = 170;
    ...
    return [
      'y' => $src_y,
      'x' => $src_x,
      'dst_img' => '/api/public/captcha/dst.png?' .  (int)(microtime(true)*1000),
      'jigsaw_img' => '/api/public/captcha/jigsaw.png?' . (int)(microtime(true)*1000),
    ];
  }
}